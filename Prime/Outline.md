...
- after questioning the system admits it is a symbiote, it gains spiritual energy from the host when the host dies and for every spiritual stone spent to the system
- the spacial storage granted stays with the system and the previous hosts storage are what the store is made from
- the system received a grate loss with its last host and that is why everything is so cheap, basically a glitch.

## technology

- internet, tv, news, communication similar to modern earth
- run on qi/beast cores rather than electricity
